 ...
 */
class DisplayProperties extends ExtensibleData
{

    /**
     * The context-specific ascendancy number for the person in relation to the other persons in the request. The
     * ancestry number is defined using the Ahnentafel numbering system.
     *
     * @var string
     */
    ...
    /**
     * The context-specific descendancy number for the person in relation to the other persons in the request. The
     * descendancy number is defined using the d'Aboville numbering system.
     *
     * @var string
     */
