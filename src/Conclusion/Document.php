...
/**
 * An abstract document that contains derived (conclusionary) text -- for example, a transcription or researcher
 * analysis.
 */
class Document extends Conclusion
{
    ...
    protected function setKnownAttribute(\XMLReader $xml)
    {
        if (parent::setKnownAttribute($xml)) {
            ...
            if (($xml->localName == 'textType') && (empty($xml->namespaceURI))) {
                $this->textType = $xml->value;

                return true;
            } else {
                if (($xml->localName == 'extracted') && (empty($xml->namespaceURI))) {
