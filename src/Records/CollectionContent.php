...
class CollectionContent extends \Gedcomx\Links\HypermediaEnabledData
{
    ...
    protected function setKnownChildElement($xml) {
        ...
        else if (($xml->localName == 'completeness') && ($xml->namespaceURI == 'http://gedcomx.org/v1/')) {
            $child = '';
        ...
        else if (($xml->localName == 'count') && ($xml->namespaceURI == 'http://gedcomx.org/v1/')) {
            $child = '';
            while ($xml->read() && $xml->hasValue) {
                $child = $child . $xml->value;
            }
        ...
        else if (($xml->localName == 'resourceType') && ($xml->namespaceURI == 'http://gedcomx.org/v1/')) {
            $child = '';
            while ($xml->read() && $xml->hasValue) {
                $child = $child . $xml->value;
            }
