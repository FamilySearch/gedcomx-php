...
The gedcomx-php SDK is the PHP implementation of [GEDCOM X](http://www.gedcomx.org) for FamilySearch, including GEDCOM X extension projects. The gedcomx-php SDK has the following features:
